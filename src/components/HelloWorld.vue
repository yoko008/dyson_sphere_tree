...
<script>
    ...
    export default {
        ...
        data: function () {
            return {
                list: [["铁块", "铜块", "高纯硅块", "钛块", "石材", "高能石墨", "氢", "精炼油", "塑料", "石墨烯"],
                    ["磁铁", "磁线圈", "晶格硅", "钛合金", "玻璃", "金刚石", "有机晶体", "液氢燃料棒", "氚核燃料棒", "反物质燃料棒"],
        ...
        mounted: function () {
            ...
            this.listDetail =
                [[tiekuai, tongkuai, gaochunguikuai, taikuai, shicai, gaonengshimo, qing, jinglianyou, suliao, shimoxi],
                    [citie, cixianquan, jinggegui, taihejin, boli, jingangshi, youjijingti, yeqingranliaobang, chuanheranliaobang, fanwuzhiranliaobang],
                    [gangcai, diandongji, taihuaboli, lengjing, taijingshi, tuijinqi, jialituijinqi, qiyiwuzhi],
                    [chilun, dianciwolun, guishi, dianluban, yinlitoujing, liusuan, zhongqing, weimianguolvqi, tannamiguan, wuliuyunshuji, xingjiwuliuyunshuchuan, xiaoxingyunzaihuojian],
                    [dianjiangfasheqi, chaojicichanghuan, lizikuandai, chuliqi, kaximierjingti, lizirongqi, kongjianqiaoquqi, yanmieyueshuqiu, taiyangfan, kuangjiacailiao, daisenqiuzujian],
                    [guangzihebingqi, weijingyuanjian, liangzixinpian, fanwuzhi],
                    [diancijuzhen, nengliaojuzhen, jiegoujuzhen, xinxijuzhen, yinlijuzhen, yuzhoujuzhen, diji]]
            this.tree = this.listDetail[0][0]
        },
        methods: {
